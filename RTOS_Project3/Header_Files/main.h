...
#define  GAME_PRIO                     27u
#define  GAME_STK_SIZE                512u
...
static  CPU_STK  Game_TaskStk[LED_TASK_STK_SIZE];
...
OS_FLAG_GRP GameFlagGroup;
OS_FLAGS    SpeedFlag     = 1;
OS_FLAGS    DirectionFlag = 2;
OS_FLAGS    LEDFlag       = 3;
OS_FLAGS    GameOverFlag  = 4;
